...
// Reset clears the accessList for reuse. Inner slot maps are cleared individually
// to allow the runtime to reuse their bucket arrays, then the outer map is cleared.
