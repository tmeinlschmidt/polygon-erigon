...
// Uses value semantics (not pointers) so the entire table is a contiguous
// ~14KB array that fits in L1 cache, eliminating a pointer dereference
// per opcode dispatch in the interpreter hot loop.
